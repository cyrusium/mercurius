...
pub async fn create_pat(
  req: HttpRequest, info: web::Json<NewPersonalAccessToken>,
  ...
  Ok(
    HttpResponse::Ok().json(PersonalAccessToken {
      id: id.into(),
      name,
...
pub async fn edit_pat(
  req: HttpRequest, id: web::Path<(String,)>,
  info: web::Json<ModifyPersonalAccessToken>, pool: Data<MySqlPool>,
  redis: Data<deadpool_redis::Pool>, session_queue: Data<AuthQueue>,
) -> Result<HttpResponse, ApiError> {
  let user = get_user_from_headers(
    &req,
    &**pool,
  ...
  let pat =
    database::models::pat_item::PersonalAccessToken::get(&id, &**pool, &redis)
      .await?;
...
pub async fn delete_pat(
  req: HttpRequest, id: web::Path<(String,)>, pool: Data<MySqlPool>,
  redis: Data<deadpool_redis::Pool>, session_queue: Data<AuthQueue>,
) -> Result<HttpResponse, ApiError> {
  let user = get_user_from_headers(
    &req,
