...
impl Notification {
  ...
  pub async fn get<'a, 'b, E>(
    id: NotificationId, executor: E,
  ) -> Result<Option<Self>, sqlx::error::Error>
  where
    E: sqlx::Executor<'a, Database = sqlx::MySql> + Copy,
  {
    Self::get_many(&[id], executor).await.map(|x| x.into_iter().next())
  }

  pub async fn get_many<'a, E>(
    notification_ids: &[NotificationId], exec: E,
  ...
  pub async fn read(
    id: NotificationId, transaction: &mut sqlx::Transaction<'_, sqlx::MySql>,
