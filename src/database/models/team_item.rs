...
impl TeamMember {
  ...
  pub async fn get_from_team_full<'a, 'b, E>(
    id: TeamId, executor: E, redis: &deadpool_redis::Pool,
  ...
  pub async fn get_from_team_full_many<'a, E>(
    team_ids: &[TeamId], exec: E, redis: &deadpool_redis::Pool,
  ) -> Result<Vec<TeamMember>, super::DatabaseError>
  where
    E: sqlx::Executor<'a, Database = sqlx::MySql> + Copy,
  {
  ...
  pub async fn clear_cache(
    id: TeamId, redis: &deadpool_redis::Pool,
  ...
  pub async fn get_from_user_id<'a, 'b, E>(
    id: TeamId, user_id: UserId, executor: E,
  ...
  pub async fn get_from_user_id_many<'a, 'b, E>(
    team_ids: &[TeamId], user_id: UserId, executor: E,
  ...
  pub async fn edit_team_member(
    id: TeamId, user_id: UserId, new_permissions: Option<Permissions>,
    new_role: Option<String>, new_accepted: Option<bool>,
    new_payouts_split: Option<Decimal>, new_ordering: Option<i64>,
    transaction: &mut sqlx::Transaction<'_, sqlx::MySql>,
  ) -> Result<(), super::DatabaseError> {
  ...
  pub async fn get_from_user_id_project<'a, 'b, E>(
    id: ProjectId, user_id: UserId, executor: E,
  ) -> Result<Option<Self>, super::DatabaseError>
  where
    E: sqlx::Executor<'a, Database = sqlx::MySql>,
  {
  ...
  pub async fn get_from_user_id_version<'a, 'b, E>(
    id: VersionId, user_id: UserId, executor: E,
  ) -> Result<Option<Self>, super::DatabaseError>
  where
    E: sqlx::Executor<'a, Database = sqlx::MySql>,
  {
