...
impl Thread {
  ...
  {
    Self::get_many(&[id], exec).await.map(|x| x.into_iter().next())
  }

  pub async fn get_many<'a, E>(
    thread_ids: &[ThreadId], exec: E,
  ...
  pub async fn remove_full(
    id: ThreadId, transaction: &mut sqlx::Transaction<'_, sqlx::MySql>,
...
impl ThreadMessage {
  ...
  pub async fn get_many<'a, E>(
    message_ids: &[ThreadMessageId], exec: E,
